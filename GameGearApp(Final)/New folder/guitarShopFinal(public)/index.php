...
define('APP_NON_WEB_BASE_DIR', NON_WEB_BASE_DIR . 'guitarShopFinal/');
...
if (hRequestMethod() === 'GET') {
	...
	// If the CSRF token was invlaid or expired, set the ctlr and action // to display the invalid form page.
    if ($vm->errorMsg !== '') {
        $action = 'invalidForm';
        $ctlr = 'home';
    }
